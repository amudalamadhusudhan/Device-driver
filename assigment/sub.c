...
int main(int argc, const char *argv[])
{
    ...
    int result = write(fd, &sub, sizeof(sub));
    if (result < 0)
    {
        printf("error writing into the user to kernal\n");
    }
    printf("success in writing sub data from user to kernal\n");
    printf("..................read section.....................\n");
    fd1 = open("/dev/subDev", O_RDWR, 0777);
    ...
    printf("success in reading data sub from user to kernal %d \n", r);
